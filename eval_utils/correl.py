"""Cross-correlation score for generated vs real windows."""
...
class _Loss(nn.Module):
    def __init__(self, name, reg=1.0, transform=lambda x: x, threshold=10.0, backward=False, norm_foo=lambda x: x):
        super().__init__()
        self.name = name
        self.reg = reg
...
def random_choice(size: int, num_select: int = 100):
